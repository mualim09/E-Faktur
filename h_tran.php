...
?>
<form action="h_tran2.php">
  <input type="hidden" name="NOMOR_FAKTUR" value="<?php echo $NOMOR_FAKTUR ?>">
  <button type="SUBMIT" class="btn btn-danger" onclick="return confirm('Anda Yakin Akan Menghapus ini ?')"><i class="fa fa-trash" ></i> HAPUS TRANSAKSI</button>
</form>
