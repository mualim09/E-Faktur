...
$awal = $_GET['awal'];
$akhir = $_GET['akhir'];
  $sql2 ="select DISTINCT PRGRNHd.GRNsupplier, SupName
from PRGRNHd inner join SmSupplierMS on PRGRNHd.GRNsupplier = SmSupplierMS.supId 
WHERE PRGRNHd.GRNDate between '2017-01-01' and '2017-12-31' order by PRGRNHd.GRNsupplier ASC";
  $hasil2 = $conn2->query($sql2);
                
$idsup = $_GET['cari'];

 $sql3 = "select DISTINCT SalesId
from PRGRNHd inner join SmSupplierMS on PRGRNHd.GRNsupplier = SmSupplierMS.supId 
WHERE PRGRNHd.GRNDate between '2017-01-01' and '2018-12-31' and PRGRNHd.GRNsupplier in ('$idsup')";
      ...
      <table class="table table-striped">
          ...
          <?php
                ...
                while ($r2 = $hasil3->fetch()) {
                        ...
                        ?>
                        <option <?php echo !empty($_GET['cari2']==$r2['SalesId'])?'selected':''; ?> ><?php echo $r2['SalesId']; ?></option>
...
$total  += $data['Total'];
  $no++;} ?>
            ...
            <input type="" name="" class="form-control" value="<?php echo round($total);?>">
