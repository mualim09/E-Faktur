...
if ($KD_JENIS_TRANSAKSI=="08") {
      
      $IS_CREDITABLE= '0';

}else if ($KD_JENIS_TRANSAKSI=="01") {
      
      $IS_CREDITABLE= '1';

}else if ($KD_JENIS_TRANSAKSI=="04") {
...
VALUES ('$FM','$KD_JENIS_TRANSAKSI','$FG_PENGGANTI','$NOMOR_FAKTUR','$MASA_PAJAK','$TAHUN_PAJAK','$TANGGAL_FAKTUR_FIX','$NPWP','$NAMA','$ALAMAT_LENGKAP','$JUMLAH_DPP','$JUMLAH_PPN','$JUMLAH_PPNBM','$IS_CREDITABLE','$now','$LINK','$EXPORT');";
...
try {
  ...
  $conn->query($sql2);
    ...
    echo "<center><h1><strong>MAAF ANDA SUDAH SCAN FAKTUR PAJAK INI...</strong></h1></center>";
    die();
  
}


  echo "<center><h3>FAKTUR PAJAK BERHASIL DISCAN..<h3></center>";
