...
header("Content-Disposition: attachment; filename=taking_toko.xls");//ganti nama sesuai keperluan
...
<center><h3>STOK TAKING TOKO / <?php echo $tgl." / ".$sk?></h3></center>
            ...
            $r2 = $conn2->query($sql2)->fetch();
             ...
             $nama = $r2['ProdName'];
                      ...
                      <tr>
                        ...
                        <td><?php echo $curr = number_format($toko,3) ?></td>
