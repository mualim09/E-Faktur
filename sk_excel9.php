...
//untuk toko
  ...
  //untuk needs
      ...
      if ($need >= $gudang) {
          ...
          elseif($segment == "11.05.09" OR $segment == "11.05.10" OR $segment == "11.05.11" OR $segment == "11.05.12" OR $segment == "11.05.13" OR $segment == "11.05.14" OR $segment == "11.05.16" OR $segment == "11.05.17"){
