  ...
  //untuk needs
      ...
      if ($need >= $gudang) {
        ...
        if ($need<=0 OR $kirim<=0) {
          ...
          elseif($segment =="11.05.20" OR $segment =="11.05.21" OR $segment =="11.05.22" OR $segment =="11.05.15" OR $segment =="11.05.18" OR $segment =="11.05.19"){
               echo '<tr><td class="text">'.$new.'</td><td class="text">'.date('d/m/Y').'</td><td class="text">001</td><td class="text">'.$no.'</td><td class="text">'.$sku.'</td><td class="text">'.$kirim.'</td><td class="text">'.$uom.'</td><td class="text">FOOD 4 AFI '.$kodeE.'TRANSFER JAM : '.$jam.'</td></tr>';
               $no++;
          }
          else{
            echo '';
